...
package es.betroop.intranet.dao.webadmin

/**
 * Created by mmacias on 28/3/16.
 */
interface WebAdminDao {
    fun checkPassword(email: String, introducedPassword:String): Boolean
}